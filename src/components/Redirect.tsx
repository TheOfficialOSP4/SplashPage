...
const Redirect = () => {
  ...
  return (
    <div className='redirect'>
      <button
        onClick={() => openInNewTab('https://github.com/oslabs-beta/ShieldQL/')}
      >
        Github
      </button>
      <button
        onClick={() =>
          openInNewTab(
            'https://medium.com/@simran00kk/shieldql-a-graphql-security-solution-6ad17f93f6fa'
          )
        }
      >
        Medium
      ...
      <button
        onClick={() => openInNewTab('https://www.npmjs.com/package/shieldql')}
      >
        NPM
      </button>
    </div>
