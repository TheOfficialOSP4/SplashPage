    ...
    return (
        <div className='features'>
            <div className='feature-nav'>
                ...
                <p onClick={() => { setCurrent(1) }}>Authorization</p>
                <p onClick={() => { setCurrent(2) }}>Authentication</p>
                <p onClick={() => { setCurrent(3) }}>Query Sanitization</p>
            </div>
            <div>
            {/* on reload, the website will show first feature and whenever a click is done on one of the p tags
                ...
                {current === 1 ? <FirstFeature />
                    : current === 2 ? <SecondFeature />
                        : <ThirdFeature />}
            </div>
